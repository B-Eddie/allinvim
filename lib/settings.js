...
`,
  ...
  // The color theme, applied to every General Vim surface (options, popup, Vomnibar, HUD, help
  ...
  theme: "trigger-dark",
  // General Vim edit-mode indicator. position: "corner" (bottom-right chip),
  ...
  generalVimIndicatorPosition: "corner",
  generalVimDocsIndicator: "bar",
